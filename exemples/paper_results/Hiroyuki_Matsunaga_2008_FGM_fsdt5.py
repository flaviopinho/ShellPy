...
from shellpy import Shell, simply_supported_fsdt5, fully_campled_fsdt5
...
if __name__ == "__main__":
    ...
    displacement_field = EnrichedCosineExpansion(expansion_size, rectangular_domain, simply_supported_fsdt5)
