...
if __name__ == "__main__":
    ...
    material = IsotropicHomogeneousLinearElasticMaterial(E_C, nu_C, rho_C)
    ...
    finite_mask = np.isfinite(eigen_vals)

    eigen_vals = eigen_vals[finite_mask]
    eigen_vectors = eigen_vectors[:, finite_mask]
