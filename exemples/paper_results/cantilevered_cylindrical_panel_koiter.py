...
from shellpy.fosd_theory2.fosd2_kinect_energy import fosd2_kinect_energy
from shellpy.fosd_theory2.fosd2_strain_energy import fosd2_quadratic_strain_energy
from shellpy.koiter_shell_theory import fast_koiter_strain_energy, fast_koiter_kinetic_energy, \
...
if __name__ == "__main__":
    ...
    T = fast_koiter_kinetic_energy(shell, integral_x, integral_y, integral_z)
    U2p = fast_koiter_quadratic_strain_energy(shell, integral_x, integral_y, integral_z)
