...
@cache_function
def constitutive_tensor_for_fosd(mid_surface_geometry: MidSurfaceGeometry, material:LinearElasticMaterial, xi1, xi2, xi3):
    ...
    return material.E / (2 * (1 + material.nu)) * (T1 + T2) + material.E * material.nu / ((1 + material.nu) * (1 - 2 * material.nu)) * T3