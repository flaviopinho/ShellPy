...
def test_constitutive_matrix_for_FOSD2():
    R = 0.1
    a = 0.1
    b = 0.1
    h = 0.001
...
def test_constitutive_matrix_for_FOSD2_grid():
    R = 0.1
    a = 0.1
    b = 0.1
    h = 0.001
    ...
    C_grid = constitutive_matrix_for_fosd2(mid_surface, material, xi1, xi2, xi3)
    ...
    for i in range(xi1.shape[0]):
        for j in range(xi2.shape[1]):
            for k in range(xi3.shape[-1]):
                ...
                y = xi2[i, j]
                z = xi3[k]
                C = constitutive_matrix_for_fosd2(mid_surface, material, x, y, z)
...
if __name__ == "__main__":
    test_constitutive_matrix_for_FOSD2()
    test_constitutive_matrix_for_FOSD2_grid()
